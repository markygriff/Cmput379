...
\noindent
Testing the execl() call was a little trickier because I had to make sure I was timing
the process correctly.
\textbf{Timing Test}: First, to test the total time elapsed, I ran a sleep command
